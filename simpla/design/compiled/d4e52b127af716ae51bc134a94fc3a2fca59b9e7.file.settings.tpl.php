<?php /* Smarty version Smarty-3.1.18, created on 2014-07-01 16:12:49
         compiled from "simpla/design/html/settings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:56107929353b2b3d1992821-62909117%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '56107929353b2b3d1992821-62909117',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53b2b3d215f846_72526011',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53b2b3d215f846_72526011')) {function content_53b2b3d215f846_72526011($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/simpla/Smarty/libs/plugins/function.math.php';
			...
			<ul>
				<li><label class=property>Разделитель копеек</label>
					<select name="decimals_point" class="simpla_inp">
						<option value='.' <?php if ($_smarty_tpl->tpl_vars['settings']->value->decimals_point=='.') {?>selected<?php }?>>точка: 12.45 рублей</option>
						<option value=',' <?php if ($_smarty_tpl->tpl_vars['settings']->value->decimals_point==',') {?>selected<?php }?>>запятая: 12,45 рублей</option>
					</select>
				</li>
				<li><label class=property>Разделитель тысяч</label>
					<select name="thousands_separator" class="simpla_inp">
						<option value='' <?php if ($_smarty_tpl->tpl_vars['settings']->value->thousands_separator=='') {?>selected<?php }?>>без разделителя: 1245678 рублей</option>
						<option value=' ' <?php if ($_smarty_tpl->tpl_vars['settings']->value->thousands_separator==' ') {?>selected<?php }?>>пробел: 1 245 678 рублей</option>
						<option value=',' <?php if ($_smarty_tpl->tpl_vars['settings']->value->thousands_separator==',') {?>selected<?php }?>>запятая: 1,245,678 рублей</option>
					</select>
